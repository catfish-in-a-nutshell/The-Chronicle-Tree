var full_dialogue = {
    ...
    "mp23": [
        "你的数字飞速成长。万倍数字之下，之前经历的村庄，营地，都已不过是脚下的一片尘土。",
        "渐渐地，天际尽头朦胧的黑影离你越来越近。那原本似乎无垠遥远的广大存在，终于现出了其全貌。",
        "你曾以为那是高耸入云的雪山。但如今，你已能够看清其构造。那只是一间为白雪所覆的巨大木屋。",
        "你意识到，自己所走过的，原本一望无际的原野，都只不过是这间木屋后院的一撮青苔而已。",
        "木屋的门轰然打开。尖锐的口哨声响彻天地。一个遮蔽天日的人形，向着你的方向走来。",
        "那是一个穿着棉衣的小女孩。她在你的面前蹲下，仿佛准备伸手按碎甲虫般，对你举起了右手食指。"
    ]
}
...
var zone_desc = {
    ...
    "mpannazone": {
        name: "安娜的后院",
        prog: [
            "女孩伸手，按下食指。天空被手腕遮蔽，而陷入一片昏暗。她将食指的关节弓起，立在你的面前，似乎在玩过家家的游戏。",
            "你划伤了女孩的手指。她不甘心地缩回了手，看来你度过了这一劫难。",
        ]
    },
}